...
public class SettingsScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 24 * (OPTIONS.length + 1) / 2, 200, 20, I18n.format("gui.back"), (button) -> {
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            this.renderTooltip(this.hoveredTooltip.getToolTip(), mouseX, mouseY);
        }
    }
