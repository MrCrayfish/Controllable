...
{
    private static final AbstractOption[] OPTIONS = new AbstractOption[]{ControllerOptions.XINPUT_ICONS, ControllerOptions.AUTO_SELECT, ControllerOptions.RENDER_MINI_PLAYER, ControllerOptions.VIRTUAL_MOUSE, ControllerOptions.DEAD_ZONE, ControllerOptions.ROTATION_SPEED, ControllerOptions.MOUSE_SPEED};
