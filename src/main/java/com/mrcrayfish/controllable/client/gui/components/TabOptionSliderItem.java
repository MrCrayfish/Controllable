...
public class TabOptionSliderItem extends TabOptionBaseItem implements Navigatable
{
    ...
    public TabOptionSliderItem(String key, ForgeConfigSpec.DoubleValue property, double stepSize, double minValue, double maxValue)
    {
        ...
        this.slider.setTooltip(Tooltip.create(Component.translatable(key + ".desc")));
