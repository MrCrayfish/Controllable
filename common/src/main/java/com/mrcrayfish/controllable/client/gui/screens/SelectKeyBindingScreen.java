...
public class SelectKeyBindingScreen extends KeyBindingListMenuScreen
{
    ...
    {
        this.resetButton = layout.addChild(ScreenHelper.button(this.width / 2 - 155, this.height - 32, 150, 20, Component.translatable("controllable.gui.reset"), (button) -> {
        ...
        layout.addChild(ScreenHelper.button(this.width / 2 + 5, this.height - 32, 150, 20, CommonComponents.GUI_DONE, (button) -> {
            this.callback.run();
