 ...
 * Author: MrCrayfish
 */
public final class ForgeControllerEntry extends AbstractSelectionList.Entry<ForgeControllerEntry> implements IControllerEntry
{
    private final ForgeControllerList controllerList;
    private final int jid;

    public ForgeControllerEntry(IControllerList<?> controllerList, int jid)
    {
        this.controllerList = (ForgeControllerList) controllerList;
        this.jid = jid;
    }
